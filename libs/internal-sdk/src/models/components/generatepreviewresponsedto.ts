...
export const GeneratePreviewResponseDtoResult1Type = {
  Email: "email",
} as const;
export type GeneratePreviewResponseDtoResult1Type = ClosedEnum<
  typeof GeneratePreviewResponseDtoResult1Type
>;

export type One = {
  type?: GeneratePreviewResponseDtoResult1Type | undefined;
 ...
 * Preview result
 */
export type Result = One | Two | Three | Result4 | Result5 | Six | Seven;
...
export type GeneratePreviewResponseDto = {
   ...
   * Preview result
   */
  result: One | Two | Three | Result4 | Result5 | Six | Seven;
};
...
/** @internal */
export const GeneratePreviewResponseDtoResult1Type$inboundSchema:
  z.ZodNativeEnum<typeof GeneratePreviewResponseDtoResult1Type> = z.nativeEnum(
    GeneratePreviewResponseDtoResult1Type,
  );

/** @internal */
export const GeneratePreviewResponseDtoResult1Type$outboundSchema:
  z.ZodNativeEnum<typeof GeneratePreviewResponseDtoResult1Type> =
    GeneratePreviewResponseDtoResult1Type$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace GeneratePreviewResponseDtoResult1Type$ {
  /** @deprecated use `GeneratePreviewResponseDtoResult1Type$inboundSchema` instead. */
  export const inboundSchema =
    GeneratePreviewResponseDtoResult1Type$inboundSchema;
  /** @deprecated use `GeneratePreviewResponseDtoResult1Type$outboundSchema` instead. */
  export const outboundSchema =
    GeneratePreviewResponseDtoResult1Type$outboundSchema;
}

/** @internal */
export const One$inboundSchema: z.ZodType<One, z.ZodTypeDef, unknown> = z
  .object({
    type: GeneratePreviewResponseDtoResult1Type$inboundSchema.optional(),
...
export const One$outboundSchema: z.ZodType<One$Outbound, z.ZodTypeDef, One> = z
  .object({
    type: GeneratePreviewResponseDtoResult1Type$outboundSchema.optional(),
