...
export type SpacingToken =
  ...
  | '350'
  | '375'
  | 'molecules.form.input.button'
  | 'paddings.page.horizontal'
  | 'paddings.page.vertical'
  | 'paddings.panel.horizontal'
  | 'paddings.panel.vertical'
  | 'paddings.popover.horizontal'
  | 'paddings.popover.vertical'
  | 'paddings.node.horizontal'
  | 'paddings.node.vertical'
  | 'paddings.nav.menu.horizontal'
  | 'paddings.nav.menu.vertical'
  | 'paddings.nav.header.horizontal'
  | 'paddings.nav.header.vertical'
  | 'paddings.nav.footer.top'
  | 'paddings.nav.footer.bottom'
  | 'paddings.WF.WFtop'
  | 'paddings.WF.WFheaderHorizontal'
  | 'paddings.WF.WFhorizontal'
  | 'paddings.WF.MobPreviewTop'
  | 'paddings.components.code.horizontal'
  | 'paddings.components.code.vertical'
  | 'paddings.components.button.horizontal.l'
  | 'paddings.components.button.horizontal.m'
  | 'paddings.components.button.horizontal.s'
  | 'paddings.components.button.horizontal.xs'
  | 'paddings.components.info.spotlight.horizontal'
  | 'paddings.components.info.spotlight.vertical'
  | 'paddings.components.info.hint.horizontal'
  | 'paddings.components.info.hint.vertical'
  | 'paddings.components.txtInput.horizontal'
  | 'margins.icons.Icon40-txt'
  | 'margins.icons.Icon32-txt'
  | 'margins.icons.Icon20-txt'
  | 'margins.icons.Icon16-txt'
  | 'margins.icons.icon20-icon20'
  | 'margins.buttons.XS-XS'
  | 'margins.buttons.WFchannels'
  | 'margins.buttons.XS-status'
  | 'margins.buttons.S-S'
  | 'margins.buttons.M-M'
  | 'margins.layout.tabs.tab-tab'
  | 'margins.layout.tabs.bottom'
  | 'margins.layout.text.title-body'
  | 'margins.layout.text.sub-title-body'
  | 'margins.layout.text.paragraph'
  | 'margins.layout.Input.titleBottom'
  | 'margins.layout.Input.input-input'
  | 'margins.layout.Input.error.top'
  | 'margins.layout.Input.error.bottom'
  | 'margins.layout.Input.bottom'
  | 'margins.layout.guideSteps'
  | 'margins.layout.page.titleBottom'
  | 'margins.layout.page.horizontal'
  | 'margins.layout.page.vertical'
  | 'margins.layout.page.section.titleBottom'
  | 'margins.layout.page.sub-section.titleBottom'
  | 'margins.layout.page.content-buttons'
  | 'margins.menu.item-item'
  | 'margins.menu.sec-sec'
  | 'workflow.nodes.gap'
  | '-0'
  | '-25'
  | '-50'
...
export type ColorToken =
  ...
  | 'legacy.B15'
  | 'legacy.B17'
  | 'legacy.gradientStart'
  | 'legacy.gradientMiddle'
  | 'legacy.gradientEnd'
  | 'legacy.success'
  | 'legacy.warning'
  | 'legacy.error'
  | 'typography.text.main'
  | 'typography.text.secondary'
  | 'typography.text.tertiary'
  | 'typography.text.disabled'
  | 'typography.text.feedback.alert'
  | 'typography.text.feedback.warning'
  | 'typography.text.feedback.info'
  | 'typography.text.feedback.success'
  | 'typography.text.feedback.required'
  | 'button.text.filled'
  | 'button.text.outline'
  | 'button.icon.filled'
  ...
  | 'surface.page'
  | 'surface.panel'
  | 'surface.panelSection'
  | 'surface.panelSubsection'
  | 'surface.popover'
  | 'icon.main'
  | 'icon.secondary'
  | 'scrollbar.color'
  ...
  | 'select.option.surface.hover'
  | 'select.option.surface.selected'
  | 'codeBlock.surface'
  | 'codeBlock.text'
  | 'variable.surface'
  | 'variable.text'
  ...
  | 'workflow.background.dots'
  | 'colorPalette.10.light'
  | 'colorPalette.light'
  | 'colorPalette.10.dark'
  | 'colorPalette.dark'
  | 'colorPalette.20.light'
  | 'colorPalette.20.dark'
  | 'colorPalette.30.light'
  | 'colorPalette.30.dark'
  | 'colorPalette.40.light'
  | 'colorPalette.40.dark'
  | 'colorPalette.50.light'
  | 'colorPalette.50.dark'
  | 'colorPalette.60.light'
  | 'colorPalette.60.dark'
  | 'colorPalette.70.light'
  | 'colorPalette.70.dark'
  | 'colorPalette.80.light'
  | 'colorPalette.80.dark'
  | 'colorPalette.90.light'
  | 'colorPalette.90.dark'
  | 'colorPalette.100.light'
  | 'colorPalette.100.dark'
  | 'colorPalette.110.light'
  | 'colorPalette.110.dark'
  | 'colorPalette.120.light'
  | 'colorPalette.120.dark'
  | 'colorPalette'
  | 'colorPalette.white'
  | 'colorPalette.black'
  ...
  | 'colorPalette.gradientMiddle'
  | 'colorPalette.gradientEnd'
  | 'colorPalette.success'
  | 'colorPalette.warning'
  | 'colorPalette.error'
  | 'colorPalette.text.main'
  | 'colorPalette.main'
  ...
  | 'colorPalette.text.feedback.alert'
  | 'colorPalette.feedback.alert'
  | 'colorPalette.alert'
  | 'colorPalette.text.feedback.warning'
  | 'colorPalette.feedback.warning'
  | 'colorPalette.text.feedback.info'
  | 'colorPalette.feedback.info'
  | 'colorPalette.info'
  | 'colorPalette.text.feedback.success'
  | 'colorPalette.feedback.success'
  | 'colorPalette.text.feedback.required'
  | 'colorPalette.feedback.required'
  | 'colorPalette.required'
  | 'colorPalette.text.filled'
  | 'colorPalette.filled'
  | 'colorPalette.text.outline'
  | 'colorPalette.outline'
  | 'colorPalette.icon.filled'
  | 'colorPalette.secondary.background'
  | 'colorPalette.background'
  | 'colorPalette.page'
  | 'colorPalette.panel'
  | 'colorPalette.panelSection'
  | 'colorPalette.panelSubsection'
  | 'colorPalette.popover'
  | 'colorPalette.color'
  | 'colorPalette.track'
  | 'colorPalette.thumb'
  | 'colorPalette.header.border'
  | 'colorPalette.border'
  | 'colorPalette.row.border'
  | 'colorPalette.row.surface.hover'
  | 'colorPalette.surface.hover'
  | 'colorPalette.hover'
  | 'colorPalette.bottom.border'
  | 'colorPalette.active'
  | 'colorPalette.inactive'
  | 'colorPalette.border.active'
  | 'colorPalette.border.disabled'
  | 'colorPalette.border.error'
  | 'colorPalette.surface'
  | 'colorPalette.surface.disabled'
  | 'colorPalette.option.surface.hover'
  | 'colorPalette.option.surface.selected'
  | 'colorPalette.surface.selected'
  | 'colorPalette.selected'
  | 'colorPalette.text'
  | 'colorPalette.overlay'
  | 'colorPalette.cloud.start'
  | 'colorPalette.start'
  | 'colorPalette.cloud.middle'
  | 'colorPalette.middle'
  | 'colorPalette.cloud.end'
  | 'colorPalette.end'
  | 'colorPalette.local.start'
  | 'colorPalette.local.middle'
  | 'colorPalette.local.end'
  | 'colorPalette.node.surface'
  | 'colorPalette.node.connector'
  | 'colorPalette.connector'
  | 'colorPalette.background.dots'
  | 'colorPalette.dots';

export type FontToken = 'system' | 'mono';

export type FontSizeToken = '75' | '88' | '100' | '125' | '150' | '175' | '225' | 'button' | 'button.small';

export type LineHeightToken = '100' | '125' | '150' | '175' | '200' | '225' | '300' | 'sm' | 'md';

export type FontWeightToken = 'regular' | 'strong';

export type LetterSpacingToken = '0';
...
export type BorderWidthToken = '0' | '100' | '200';

export type BorderToken = 'none' | 'solid' | 'double' | 'dashed';
...
export type OpacityToken = '0' | '20' | '40' | '50' | '60' | '80' | '100' | 'disabled' | 'hover';
...
export type SizeToken =
  ...
  | '375'
  | 'onboarding'
  | 'userSettings.buttonWidth'
  | 'components.input.height'
  | 'components.menu.height'
  | 'components.menu.width'
  | 'icon.16'
  | 'icon.20'
  | 'icon.24'
  | 'full'
...
export type ShadowToken = 'light' | 'medium' | 'dark' | 'color';

export type GradientToken = 'vertical' | 'horizontal' | 'disabled' | 'darkDisabled';
