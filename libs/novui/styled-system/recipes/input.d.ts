...
export interface InputRecipe {
  ...
  ): Pretty<Record<'root' | 'input' | 'wrapper' | 'section' | 'description' | 'error' | 'required' | 'label', string>>;
  ...
  splitVariantProps<Props extends InputVariantProps>(
    props: Props
  ): [InputVariantProps, Pretty<DistributiveOmit<Props, keyof InputVariantProps>>];
